...
OmniMCP demonstrates significant improvements over baselines across all three benchmark datasets. Particularly notable is the 17.8\% improvement in task success rate for cross-application workflows compared to OmniParser alone, highlighting the effectiveness of our temporal pattern learning through process graphs. The framework shows particular effectiveness in adapting to visual variations, achieving 81.9\% success in the VisualVar-20 dataset compared to 64.2\% for OmniParser and 42.3\% for Sikuli.
